 ...
 */
package cn.com.shuchang.springboot.study.async.method2.processors;
...
public class AsyncEnvironmentPostProcessor implements EnvironmentPostProcessor, Ordered {
    ...
    public void postProcessEnvironment(ConfigurableEnvironment environment, SpringApplication application) {
        ...
        try {
            source = loadProfiles(new FileUrlResource(this.getClass().getClassLoader().getResource("sync.yml")));
        } catch (IOException e) {
            e.printStackTrace();
        }
        // 添加到Environment
